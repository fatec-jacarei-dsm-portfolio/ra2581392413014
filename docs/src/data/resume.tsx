  ...
  projects: [
    {
      ...
      active: true,
      description:
        'Desenvolvido para ajudar a gerenciar gastos pessoais. Com uma interface simples e amigável, permite o acompanhamento de despesas, categorização e visualização de hábitos financeiros por meio de gráficos intuitivos.',
      technologies: [
        'Next.js',
        'Typescript',
        'SQLite',
    ...
    },
    {
      ...
      active: true,
      description:
        'Gerenciamento de alimentação e nutrição, permitindo que os usuários registrem suas refeições, monitorem suas metas nutricionais e tenham acompanhamento de nutricionistas.',
      technologies: [
        'React',
        'Typescript',
        'Node.js',
